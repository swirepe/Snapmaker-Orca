...
public:
    ...
    void            initialize_non_traversable_travel(const Print &print) { m_non_traversable_travel.initialize(print); }
    ...
    std::string     unlift();
    std::string     unretract() { return this->unlift() + m_writer.unretract(); }
