...
bool Model::is_thermal_pattern_painted() const
{
    return std::any_of(this->objects.cbegin(), this->objects.cend(), [](const ModelObject *mo) { return mo->is_thermal_pattern_painted(); });
}
...
bool ModelObject::is_thermal_pattern_painted() const
{
...
bool model_thermal_pattern_data_changed(const ModelObject &mo, const ModelObject &mo_new)
{
    return model_property_changed(mo, mo_new,
        [](const ModelVolumeType t) { return t == ModelVolumeType::MODEL_PART; },
